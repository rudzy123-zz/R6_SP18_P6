...
void Statistics::reportStats() const {
    ...
    if (countTotal != 0) {
        std::cout << abs((double)waitTimeTotal / (double)countTotal);
    }
    else {
        std::cout << 0.0;
    }
    ...
    if (count1 != 0) {
        std::cout << abs((double)waitTime1 / (double)count1);
    }
    else {
        std::cout << 0.0;
    }
    ...
    std::cout << "\t\tAverage wait time: ";
    if (count2 != 0) {
        std::cout << abs((double)waitTime2 / (double)count2);
    }
    else {
        std::cout << 0.0;
    }
    ...
    std::cout << "\t\tAverage wait time: ";
    if (count3 != 0) {
        std::cout << std::abs((double)waitTime3 / (double)count3);
    }
    else {
        std::cout << 0.0;
    }
